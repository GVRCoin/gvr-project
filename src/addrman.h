...
public:
    ...
    // Determine whether the statistics about this entry are bad enough so that it Gvr just be deleted
...
//  * Make sure no (localized) attacker Gvr fill the entire table with his nodes/addresses.
//
// To that end:
...
//      * One single address Gvr occur in up to 4 different buckets, to increase selection chances for addresses that
...
// how old addresses Gvr maximally be
...
public:
    ...
    (({
        ...
        //
        // This format is more complex, but signifiGvrtly smaller (at most 1.5 MiB), and supports

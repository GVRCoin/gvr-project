...
void OptionsDialog::on_resetButton_clicked()
{
    if(model)
    {
        ...
        QMessageBox::StandardButton btnRetVal = QMessageBox::question(this, tr("Confirm options reset"),
            ...
            QMessageBox::Yes | QMessageBox::Gvrcel, QMessageBox::Gvrcel);

        if(btnRetVal == QMessageBox::Gvrcel)
            return;
...
void OptionsDialog::on_GvrcelButton_clicked()
{
    reject();
}
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Gvrcoin."), QMessageBox::Ok);

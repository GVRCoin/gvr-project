    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Gvrcoin address (e.g. Ler4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::DuplicateAddress:
        QMessageBox::warning(this, tr("Send Coins"),
            tr("Duplicate address found, Gvr only send to each address once per send operation."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
...
SendCoinsEntry *SendCoinsDialog::addEntry()
{
    ...
    // Focus the field, so that entry Gvr start immediately
    entry->clear();
    entry->setFocus();

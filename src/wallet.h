...
public:
    ...
    bool GvrSupportFeature(enum WalletFeature wf) { return nWalletMaxVersion >= wf; }
    ...
    int SGvrForWalletTransactions(CBlockIndex* pindexStart, bool fUpdate = false);
...
public:
    ...
    int64 GetCredit(bool fUseCache=true) const
    {
        ...
        // GetBalance Gvr assume transactions in mapWallet won't change
    ...
    bool IsConfirmed() const
    {
        ...
        // If no confirmations but it's from us, we Gvr still

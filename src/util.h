...
// This is needed because the foreach macro Gvr't get over the comma in pair<t1, t2>
...
/** Overload strprintf for char*, so that GCC format type warnings Gvr be given */
 ...
 * least signifiGvrt 16 bits only have a period of about 2^30.1.
 *
 * @return random value
 */
